...
namespace CompanyEmployees.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
            ...
            [FromQuery]EmployeeParameters employeeParameters)
        {
            ...
            Response.Headers.Add("X-Pagination", JsonConvert.SerializeObject(employeesFromDb.Result.MetaData));

            //var employeeDto = _mapper.Map<IEnumerable<EmployeeDto>>(employeesFromDb);

            var employeeDto = _mapper.Map<PagedList<Employee>,IEnumerable<EmployeeDto>>(employeesFromDb.Result);
        ...
        public async Task<IActionResult> CreateEmployeeForCompany(Guid companyId, [FromBody] EmployeeForCreationDto employee)
        {
            ...
            return CreatedAtRoute("GetEmployeeForCompany", 
                new { companyId = companyId, id = employeeToReturn.Id }, 
                employeeToReturn);
        }
